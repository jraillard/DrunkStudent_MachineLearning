...
for i in ['linear','poly','rbf','sigmoid']:
    SVC_Dalc = SVC(kernel = i)
    SVC_Walc = SVC(kernel = i)

    SVC_Dalc.fit(train_data_Dalc,train_data_labels_Dalc)
    SVC_Walc.fit(train_data_Walc,train_data_labels_Walc)

    predicted_labels_Dalc = SVC_Dalc.predict(test_data_Dalc)
    predicted_labels_Walc = SVC_Walc.predict(test_data_Walc)
