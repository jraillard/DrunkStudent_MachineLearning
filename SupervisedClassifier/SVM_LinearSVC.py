...
for i in [10,100,500,1000,10000]:
    linearSVC_Dalc = LinearSVC(C = i)
    linearSVC_Walc = LinearSVC(C = i)

    linearSVC_Dalc.fit(train_data_Dalc,train_data_labels_Dalc)
    linearSVC_Walc.fit(train_data_Walc,train_data_labels_Walc)

    predicted_labels_Dalc = linearSVC_Dalc.predict(test_data_Dalc)
    predicted_labels_Walc = linearSVC_Walc.predict(test_data_Walc)
