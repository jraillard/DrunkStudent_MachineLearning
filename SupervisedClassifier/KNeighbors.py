...
##################
# CLASSIFICATION
for i in [3,7,8,10,15,20,50]:

    neighbors_Dalc=sk.neighbors.KNeighborsClassifier(n_neighbors=i)
    neighbors_Dalc.fit(train_data_Dalc,train_data_labels_Dalc)
    predicted_labels_Dalc=neighbors_Dalc.predict(test_data_Dalc) #predicting

    neighbors_Walc=sk.neighbors.KNeighborsClassifier(n_neighbors=i)
    neighbors_Walc.fit(train_data_Walc,train_data_labels_Walc)
    predicted_labels_Walc=neighbors_Walc.predict(test_data_Walc) #predicting
