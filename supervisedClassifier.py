...
############################
# Chargement CSV: 100 first lines (2 classes) et un seul descripteur (SepalWidthCm)
data_df = pd.read_csv('student-mat.csv')
data_df=data_df.iloc[:100,:]

data_df=data_df[['school', 'sex', 'age', 'address', 'famsize', 'Pstatus', 'Medu', 'Fedu',
       'Mjob', 'Fjob', 'reason', 'guardian', 'traveltime', 'studytime',
       'failures', 'schoolsup', 'famsup', 'paid', 'activities', 'nursery',
       'higher', 'internet', 'romantic', 'famrel', 'freetime', 'goout', 'Dalc',
       'Walc', 'health', 'absences', 'G1', 'G2', 'G3']
] #;print(data_df.head(-1));quit()
